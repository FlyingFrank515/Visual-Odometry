...
//       
//       Creation Date:  Wed Nov 23 16:35:51 2022
//       Version: 	r5p0
//
...
`ifdef POWER_PINS
module sram_keybuf2 (VDDCE, VDDPE, VSSE, CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB,
...
`else
module sram_keybuf2 (CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB, DYB, QA, QB, CLKA,
...
`endif
  ...
  parameter WORDS = 128;
  parameter MUX = 8;
  parameter MEM_WIDTH = 568; // redun block size 4, 280 on left, 288 on right
  parameter MEM_HEIGHT = 16;
  parameter WP_SIZE = 71 ;
...
`endif
  ...
  reg [567:0] new_data;
  reg [567:0] data_out;
  reg [141:0] readLatch0;
  reg [141:0] shifted_readLatch0;
  reg  read_mux_sel0;
  reg [141:0] readLatch1;
  reg [141:0] shifted_readLatch1;
  reg  read_mux_sel1;
  reg LAST_CLKB;
  reg [70:0] QA_int;
  reg [70:0] QA_int_delayed;
  reg [70:0] QB_int;
  reg [70:0] QB_int_delayed;
  reg [70:0] writeEnable;
  real previous_CLKA;
  real previous_CLKB;
  ...
  reg NOT_CENA, NOT_WENA, NOT_AA6, NOT_AA5, NOT_AA4, NOT_AA3, NOT_AA2, NOT_AA1, NOT_AA0;
  reg NOT_DA70, NOT_DA69, NOT_DA68, NOT_DA67, NOT_DA66, NOT_DA65, NOT_DA64, NOT_DA63;
  reg NOT_DA62, NOT_DA61, NOT_DA60, NOT_DA59, NOT_DA58, NOT_DA57, NOT_DA56, NOT_DA55;
  reg NOT_DA54, NOT_DA53, NOT_DA52, NOT_DA51, NOT_DA50, NOT_DA49, NOT_DA48, NOT_DA47;
  reg NOT_DA46, NOT_DA45, NOT_DA44, NOT_DA43, NOT_DA42, NOT_DA41, NOT_DA40, NOT_DA39;
  reg NOT_DA38, NOT_DA37, NOT_DA36, NOT_DA35, NOT_DA34, NOT_DA33, NOT_DA32, NOT_DA31;
  reg NOT_DA30, NOT_DA29, NOT_DA28, NOT_DA27, NOT_DA26, NOT_DA25, NOT_DA24, NOT_DA23;
  reg NOT_DA22, NOT_DA21, NOT_DA20, NOT_DA19, NOT_DA18, NOT_DA17, NOT_DA16, NOT_DA15;
  ...
  reg NOT_AB6, NOT_AB5, NOT_AB4, NOT_AB3, NOT_AB2, NOT_AB1, NOT_AB0, NOT_DB70, NOT_DB69;
  ...
  reg NOT_EMASB, NOT_TENA, NOT_TCENA, NOT_TWENA, NOT_TAA6, NOT_TAA5, NOT_TAA4, NOT_TAA3;
  reg NOT_TAA2, NOT_TAA1, NOT_TAA0, NOT_TDA70, NOT_TDA69, NOT_TDA68, NOT_TDA67, NOT_TDA66;
  reg NOT_TDA65, NOT_TDA64, NOT_TDA63, NOT_TDA62, NOT_TDA61, NOT_TDA60, NOT_TDA59;
  ...
  reg NOT_TDA1, NOT_TDA0, NOT_TENB, NOT_TCENB, NOT_TWENB, NOT_TAB6, NOT_TAB5, NOT_TAB4;
  reg NOT_TAB3, NOT_TAB2, NOT_TAB1, NOT_TAB0, NOT_TDB70, NOT_TDB69, NOT_TDB68, NOT_TDB67;
 ...
 wire  CLKB_;
  ...
  assign `ARM_UD_DP DYA_ = RET1N_ ? (TENA_ ? DA_ : TDA_) : {71{1'bx}};
  ...
  assign `ARM_UD_DP DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {71{1'bx}};
  assign `ARM_UD_SEQ QA_ = RET1N_ ? (BENA_ ? ((STOVA_ ? (QA_int_delayed) : (QA_int))) : TQA_) : {71{1'bx}};
  assign `ARM_UD_SEQ QB_ = RET1N_ ? (BENB_ ? ((STOVB_ ? (QB_int_delayed) : (QB_int))) : TQB_) : {71{1'bx}};
  ...
  begin
	$readmemb(filename, memld);
     if (CENA_ === 1'b1 && CENB_ === 1'b1) begin
      ...
      row = mem[row_address];
        writeEnable = {71{1'b1}};
        row_mask =  ( {7'b0000000, writeEnable[70], 7'b0000000, writeEnable[69], 7'b0000000, writeEnable[68],
        ...
        new_data =  ( {7'b0000000, wordtemp[70], 7'b0000000, wordtemp[69], 7'b0000000, wordtemp[68],
	...
	dump_file_desc = $fopen(filename_dump);
     if (CENA_ === 1'b1 && CENB_ === 1'b1) begin
      ...
      row = mem[row_address];
        ...
        readLatch0 = {data_out[564], data_out[560], data_out[556], data_out[552], data_out[548],
      ...
      QA_int = {shifted_readLatch0[140], shifted_readLatch0[138], shifted_readLatch0[136],
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
     ...
     && !CENA_int)} === 1'bx) begin
      ...
      QA_int = WENA_int !== 1'b1 ? QA_int : {71{1'bx}};
      QA_int_delayed = WENA_int !== 1'b1 ? QA_int_delayed : {71{1'bx}};
      ...
      if (WENA_int !== 1'b1) begin
        row_mask =  ( {7'b0000000, writeEnable[70], 7'b0000000, writeEnable[69], 7'b0000000, writeEnable[68],
          ...
          7'b0000000, writeEnable[4], 7'b0000000, writeEnable[3], 7'b0000000, writeEnable[2],
          7'b0000000, writeEnable[1], 7'b0000000, writeEnable[0]} << mux_address);
        new_data =  ( {7'b0000000, DA_int[70], 7'b0000000, DA_int[69], 7'b0000000, DA_int[68],
          7'b0000000, DA_int[67], 7'b0000000, DA_int[66], 7'b0000000, DA_int[65], 7'b0000000, DA_int[64],
          7'b0000000, DA_int[63], 7'b0000000, DA_int[62], 7'b0000000, DA_int[61], 7'b0000000, DA_int[60],
          7'b0000000, DA_int[59], 7'b0000000, DA_int[58], 7'b0000000, DA_int[57], 7'b0000000, DA_int[56],
          7'b0000000, DA_int[55], 7'b0000000, DA_int[54], 7'b0000000, DA_int[53], 7'b0000000, DA_int[52],
          7'b0000000, DA_int[51], 7'b0000000, DA_int[50], 7'b0000000, DA_int[49], 7'b0000000, DA_int[48],
          7'b0000000, DA_int[47], 7'b0000000, DA_int[46], 7'b0000000, DA_int[45], 7'b0000000, DA_int[44],
          7'b0000000, DA_int[43], 7'b0000000, DA_int[42], 7'b0000000, DA_int[41], 7'b0000000, DA_int[40],
          7'b0000000, DA_int[39], 7'b0000000, DA_int[38], 7'b0000000, DA_int[37], 7'b0000000, DA_int[36],
          7'b0000000, DA_int[35], 7'b0000000, DA_int[34], 7'b0000000, DA_int[33], 7'b0000000, DA_int[32],
          7'b0000000, DA_int[31], 7'b0000000, DA_int[30], 7'b0000000, DA_int[29], 7'b0000000, DA_int[28],
          7'b0000000, DA_int[27], 7'b0000000, DA_int[26], 7'b0000000, DA_int[25], 7'b0000000, DA_int[24],
          7'b0000000, DA_int[23], 7'b0000000, DA_int[22], 7'b0000000, DA_int[21], 7'b0000000, DA_int[20],
          7'b0000000, DA_int[19], 7'b0000000, DA_int[18], 7'b0000000, DA_int[17], 7'b0000000, DA_int[16],
          7'b0000000, DA_int[15], 7'b0000000, DA_int[14], 7'b0000000, DA_int[13], 7'b0000000, DA_int[12],
          7'b0000000, DA_int[11], 7'b0000000, DA_int[10], 7'b0000000, DA_int[9], 7'b0000000, DA_int[8],
          7'b0000000, DA_int[7], 7'b0000000, DA_int[6], 7'b0000000, DA_int[5], 7'b0000000, DA_int[4],
          7'b0000000, DA_int[3], 7'b0000000, DA_int[2], 7'b0000000, DA_int[1], 7'b0000000, DA_int[0]} << mux_address);
        row = (row & ~row_mask) | (row_mask & (~row_mask | new_data));
        mem[row_address] = row;
      end else begin
  ...
  begin
    if (RET1N_int === 1'bx || RET1N_int === 1'bz) begin
     ...
     && !CENB_int)} === 1'bx) begin
      ...
      QB_int = WENB_int !== 1'b1 ? QB_int : {71{1'bx}};
      QB_int_delayed = WENB_int !== 1'b1 ? QB_int_delayed : {71{1'bx}};
      ...
      if (WENB_int !== 1'b1) begin
        row_mask =  ( {7'b0000000, writeEnable[70], 7'b0000000, writeEnable[69], 7'b0000000, writeEnable[68],
          ...
          7'b0000000, writeEnable[4], 7'b0000000, writeEnable[3], 7'b0000000, writeEnable[2],
          7'b0000000, writeEnable[1], 7'b0000000, writeEnable[0]} << mux_address);
        new_data =  ( {7'b0000000, DB_int[70], 7'b0000000, DB_int[69], 7'b0000000, DB_int[68],
          7'b0000000, DB_int[67], 7'b0000000, DB_int[66], 7'b0000000, DB_int[65], 7'b0000000, DB_int[64],
          7'b0000000, DB_int[63], 7'b0000000, DB_int[62], 7'b0000000, DB_int[61], 7'b0000000, DB_int[60],
          7'b0000000, DB_int[59], 7'b0000000, DB_int[58], 7'b0000000, DB_int[57], 7'b0000000, DB_int[56],
          7'b0000000, DB_int[55], 7'b0000000, DB_int[54], 7'b0000000, DB_int[53], 7'b0000000, DB_int[52],
          7'b0000000, DB_int[51], 7'b0000000, DB_int[50], 7'b0000000, DB_int[49], 7'b0000000, DB_int[48],
          7'b0000000, DB_int[47], 7'b0000000, DB_int[46], 7'b0000000, DB_int[45], 7'b0000000, DB_int[44],
          7'b0000000, DB_int[43], 7'b0000000, DB_int[42], 7'b0000000, DB_int[41], 7'b0000000, DB_int[40],
          7'b0000000, DB_int[39], 7'b0000000, DB_int[38], 7'b0000000, DB_int[37], 7'b0000000, DB_int[36],
          7'b0000000, DB_int[35], 7'b0000000, DB_int[34], 7'b0000000, DB_int[33], 7'b0000000, DB_int[32],
          7'b0000000, DB_int[31], 7'b0000000, DB_int[30], 7'b0000000, DB_int[29], 7'b0000000, DB_int[28],
          7'b0000000, DB_int[27], 7'b0000000, DB_int[26], 7'b0000000, DB_int[25], 7'b0000000, DB_int[24],
          7'b0000000, DB_int[23], 7'b0000000, DB_int[22], 7'b0000000, DB_int[21], 7'b0000000, DB_int[20],
          7'b0000000, DB_int[19], 7'b0000000, DB_int[18], 7'b0000000, DB_int[17], 7'b0000000, DB_int[16],
          7'b0000000, DB_int[15], 7'b0000000, DB_int[14], 7'b0000000, DB_int[13], 7'b0000000, DB_int[12],
          7'b0000000, DB_int[11], 7'b0000000, DB_int[10], 7'b0000000, DB_int[9], 7'b0000000, DB_int[8],
          7'b0000000, DB_int[7], 7'b0000000, DB_int[6], 7'b0000000, DB_int[5], 7'b0000000, DB_int[4],
          7'b0000000, DB_int[3], 7'b0000000, DB_int[2], 7'b0000000, DB_int[1], 7'b0000000, DB_int[0]} << mux_address);
        row = (row & ~row_mask) | (row_mask & (~row_mask | new_data));
        mem[row_address] = row;
      end else begin
        data_out = (row >> (mux_address%4));
        readLatch1 = {data_out[564], data_out[560], data_out[556], data_out[552], data_out[548],
          data_out[544], data_out[540], data_out[536], data_out[532], data_out[528],
          data_out[524], data_out[520], data_out[516], data_out[512], data_out[508],
          data_out[504], data_out[500], data_out[496], data_out[492], data_out[488],
          data_out[484], data_out[480], data_out[476], data_out[472], data_out[468],
      ...
      QB_int = {shifted_readLatch1[140], shifted_readLatch1[138], shifted_readLatch1[136],
        shifted_readLatch1[134], shifted_readLatch1[132], shifted_readLatch1[130],
        shifted_readLatch1[128], shifted_readLatch1[126], shifted_readLatch1[124],
        shifted_readLatch1[122], shifted_readLatch1[120], shifted_readLatch1[118],
        shifted_readLatch1[116], shifted_readLatch1[114], shifted_readLatch1[112],
        shifted_readLatch1[110], shifted_readLatch1[108], shifted_readLatch1[106],
        shifted_readLatch1[104], shifted_readLatch1[102], shifted_readLatch1[100],
        shifted_readLatch1[98], shifted_readLatch1[96], shifted_readLatch1[94], shifted_readLatch1[92],
        shifted_readLatch1[90], shifted_readLatch1[88], shifted_readLatch1[86], shifted_readLatch1[84],
        shifted_readLatch1[82], shifted_readLatch1[80], shifted_readLatch1[78], shifted_readLatch1[76],
        shifted_readLatch1[74], shifted_readLatch1[72], shifted_readLatch1[70], shifted_readLatch1[68],
        shifted_readLatch1[66], shifted_readLatch1[64], shifted_readLatch1[62], shifted_readLatch1[60],
        shifted_readLatch1[58], shifted_readLatch1[56], shifted_readLatch1[54], shifted_readLatch1[52],
        shifted_readLatch1[50], shifted_readLatch1[48], shifted_readLatch1[46], shifted_readLatch1[44],
        shifted_readLatch1[42], shifted_readLatch1[40], shifted_readLatch1[38], shifted_readLatch1[36],
        shifted_readLatch1[34], shifted_readLatch1[32], shifted_readLatch1[30], shifted_readLatch1[28],
        shifted_readLatch1[26], shifted_readLatch1[24], shifted_readLatch1[22], shifted_readLatch1[20],
        shifted_readLatch1[18], shifted_readLatch1[16], shifted_readLatch1[14], shifted_readLatch1[12],
        shifted_readLatch1[10], shifted_readLatch1[8], shifted_readLatch1[6], shifted_readLatch1[4],
        shifted_readLatch1[2], shifted_readLatch1[0]};
      end
    end
  end
  endtask
...
`endif
 ...
 wire  CLKB_;
  ...
  buf B8(AYA[6], AYA_[6]);
  buf B9(DYA[0], DYA_[0]);
  buf B10(DYA[1], DYA_[1]);
  buf B11(DYA[2], DYA_[2]);
  buf B12(DYA[3], DYA_[3]);
  buf B13(DYA[4], DYA_[4]);
  buf B14(DYA[5], DYA_[5]);
  buf B15(DYA[6], DYA_[6]);
  buf B16(DYA[7], DYA_[7]);
  buf B17(DYA[8], DYA_[8]);
  buf B18(DYA[9], DYA_[9]);
  buf B19(DYA[10], DYA_[10]);
  buf B20(DYA[11], DYA_[11]);
  buf B21(DYA[12], DYA_[12]);
  buf B22(DYA[13], DYA_[13]);
  buf B23(DYA[14], DYA_[14]);
  buf B24(DYA[15], DYA_[15]);
  buf B25(DYA[16], DYA_[16]);
  buf B26(DYA[17], DYA_[17]);
  buf B27(DYA[18], DYA_[18]);
  buf B28(DYA[19], DYA_[19]);
  buf B29(DYA[20], DYA_[20]);
  buf B30(DYA[21], DYA_[21]);
  buf B31(DYA[22], DYA_[22]);
  buf B32(DYA[23], DYA_[23]);
  buf B33(DYA[24], DYA_[24]);
  buf B34(DYA[25], DYA_[25]);
  buf B35(DYA[26], DYA_[26]);
  buf B36(DYA[27], DYA_[27]);
  buf B37(DYA[28], DYA_[28]);
  buf B38(DYA[29], DYA_[29]);
  buf B39(DYA[30], DYA_[30]);
  buf B40(DYA[31], DYA_[31]);
  buf B41(DYA[32], DYA_[32]);
  buf B42(DYA[33], DYA_[33]);
  buf B43(DYA[34], DYA_[34]);
  buf B44(DYA[35], DYA_[35]);
  buf B45(DYA[36], DYA_[36]);
  buf B46(DYA[37], DYA_[37]);
  buf B47(DYA[38], DYA_[38]);
  buf B48(DYA[39], DYA_[39]);
  buf B49(DYA[40], DYA_[40]);
  buf B50(DYA[41], DYA_[41]);
  buf B51(DYA[42], DYA_[42]);
  buf B52(DYA[43], DYA_[43]);
  buf B53(DYA[44], DYA_[44]);
  buf B54(DYA[45], DYA_[45]);
  buf B55(DYA[46], DYA_[46]);
  buf B56(DYA[47], DYA_[47]);
  buf B57(DYA[48], DYA_[48]);
  buf B58(DYA[49], DYA_[49]);
  buf B59(DYA[50], DYA_[50]);
  buf B60(DYA[51], DYA_[51]);
  buf B61(DYA[52], DYA_[52]);
  buf B62(DYA[53], DYA_[53]);
  buf B63(DYA[54], DYA_[54]);
  buf B64(DYA[55], DYA_[55]);
  buf B65(DYA[56], DYA_[56]);
  buf B66(DYA[57], DYA_[57]);
  buf B67(DYA[58], DYA_[58]);
  buf B68(DYA[59], DYA_[59]);
  buf B69(DYA[60], DYA_[60]);
  buf B70(DYA[61], DYA_[61]);
  buf B71(DYA[62], DYA_[62]);
  buf B72(DYA[63], DYA_[63]);
  buf B73(DYA[64], DYA_[64]);
  buf B74(DYA[65], DYA_[65]);
  buf B75(DYA[66], DYA_[66]);
  buf B76(DYA[67], DYA_[67]);
  buf B77(DYA[68], DYA_[68]);
  buf B78(DYA[69], DYA_[69]);
  buf B79(DYA[70], DYA_[70]);
  buf B80(CENYB, CENYB_);
  buf B81(WENYB, WENYB_);
  buf B82(AYB[0], AYB_[0]);
  buf B83(AYB[1], AYB_[1]);
  buf B84(AYB[2], AYB_[2]);
  buf B85(AYB[3], AYB_[3]);
  buf B86(AYB[4], AYB_[4]);
  buf B87(AYB[5], AYB_[5]);
  buf B88(AYB[6], AYB_[6]);
  buf B89(DYB[0], DYB_[0]);
  buf B90(DYB[1], DYB_[1]);
  buf B91(DYB[2], DYB_[2]);
  buf B92(DYB[3], DYB_[3]);
  buf B93(DYB[4], DYB_[4]);
  buf B94(DYB[5], DYB_[5]);
  buf B95(DYB[6], DYB_[6]);
  buf B96(DYB[7], DYB_[7]);
  buf B97(DYB[8], DYB_[8]);
  buf B98(DYB[9], DYB_[9]);
  buf B99(DYB[10], DYB_[10]);
  buf B100(DYB[11], DYB_[11]);
  buf B101(DYB[12], DYB_[12]);
  buf B102(DYB[13], DYB_[13]);
  buf B103(DYB[14], DYB_[14]);
  buf B104(DYB[15], DYB_[15]);
  buf B105(DYB[16], DYB_[16]);
  buf B106(DYB[17], DYB_[17]);
  buf B107(DYB[18], DYB_[18]);
  buf B108(DYB[19], DYB_[19]);
  buf B109(DYB[20], DYB_[20]);
  buf B110(DYB[21], DYB_[21]);
  buf B111(DYB[22], DYB_[22]);
  buf B112(DYB[23], DYB_[23]);
  buf B113(DYB[24], DYB_[24]);
  buf B114(DYB[25], DYB_[25]);
  buf B115(DYB[26], DYB_[26]);
  buf B116(DYB[27], DYB_[27]);
  buf B117(DYB[28], DYB_[28]);
  buf B118(DYB[29], DYB_[29]);
  buf B119(DYB[30], DYB_[30]);
  buf B120(DYB[31], DYB_[31]);
  buf B121(DYB[32], DYB_[32]);
  buf B122(DYB[33], DYB_[33]);
  buf B123(DYB[34], DYB_[34]);
  buf B124(DYB[35], DYB_[35]);
  buf B125(DYB[36], DYB_[36]);
  buf B126(DYB[37], DYB_[37]);
  buf B127(DYB[38], DYB_[38]);
  buf B128(DYB[39], DYB_[39]);
  buf B129(DYB[40], DYB_[40]);
  buf B130(DYB[41], DYB_[41]);
  buf B131(DYB[42], DYB_[42]);
  buf B132(DYB[43], DYB_[43]);
  buf B133(DYB[44], DYB_[44]);
  buf B134(DYB[45], DYB_[45]);
  buf B135(DYB[46], DYB_[46]);
  buf B136(DYB[47], DYB_[47]);
  buf B137(DYB[48], DYB_[48]);
  buf B138(DYB[49], DYB_[49]);
  buf B139(DYB[50], DYB_[50]);
  buf B140(DYB[51], DYB_[51]);
  buf B141(DYB[52], DYB_[52]);
  buf B142(DYB[53], DYB_[53]);
  buf B143(DYB[54], DYB_[54]);
  buf B144(DYB[55], DYB_[55]);
  buf B145(DYB[56], DYB_[56]);
  buf B146(DYB[57], DYB_[57]);
  buf B147(DYB[58], DYB_[58]);
  buf B148(DYB[59], DYB_[59]);
  buf B149(DYB[60], DYB_[60]);
  buf B150(DYB[61], DYB_[61]);
  buf B151(DYB[62], DYB_[62]);
  buf B152(DYB[63], DYB_[63]);
  buf B153(DYB[64], DYB_[64]);
  buf B154(DYB[65], DYB_[65]);
  buf B155(DYB[66], DYB_[66]);
  buf B156(DYB[67], DYB_[67]);
  buf B157(DYB[68], DYB_[68]);
  buf B158(DYB[69], DYB_[69]);
  buf B159(DYB[70], DYB_[70]);
  buf B160(QA[0], QA_[0]);
  buf B161(QA[1], QA_[1]);
  buf B162(QA[2], QA_[2]);
  buf B163(QA[3], QA_[3]);
  ...
  buf B239(QB[8], QB_[8]);
  buf B240(QB[9], QB_[9]);
  buf B241(QB[10], QB_[10]);
  buf B242(QB[11], QB_[11]);
  buf B243(QB[12], QB_[12]);
  buf B244(QB[13], QB_[13]);
  buf B245(QB[14], QB_[14]);
  buf B246(QB[15], QB_[15]);
  buf B247(QB[16], QB_[16]);
  buf B248(QB[17], QB_[17]);
  buf B249(QB[18], QB_[18]);
  buf B250(QB[19], QB_[19]);
  buf B251(QB[20], QB_[20]);
  buf B252(QB[21], QB_[21]);
  buf B253(QB[22], QB_[22]);
  buf B254(QB[23], QB_[23]);
  buf B255(QB[24], QB_[24]);
  buf B256(QB[25], QB_[25]);
  buf B257(QB[26], QB_[26]);
  buf B258(QB[27], QB_[27]);
  buf B259(QB[28], QB_[28]);
  buf B260(QB[29], QB_[29]);
  buf B261(QB[30], QB_[30]);
  buf B262(QB[31], QB_[31]);
  buf B263(QB[32], QB_[32]);
  buf B264(QB[33], QB_[33]);
  buf B265(QB[34], QB_[34]);
  buf B266(QB[35], QB_[35]);
  buf B267(QB[36], QB_[36]);
  buf B268(QB[37], QB_[37]);
  buf B269(QB[38], QB_[38]);
  buf B270(QB[39], QB_[39]);
  buf B271(QB[40], QB_[40]);
  buf B272(QB[41], QB_[41]);
  buf B273(QB[42], QB_[42]);
  buf B274(QB[43], QB_[43]);
  buf B275(QB[44], QB_[44]);
  buf B276(QB[45], QB_[45]);
  buf B277(QB[46], QB_[46]);
  buf B278(QB[47], QB_[47]);
  buf B279(QB[48], QB_[48]);
  buf B280(QB[49], QB_[49]);
  buf B281(QB[50], QB_[50]);
  buf B282(QB[51], QB_[51]);
  buf B283(QB[52], QB_[52]);
  buf B284(QB[53], QB_[53]);
  buf B285(QB[54], QB_[54]);
  buf B286(QB[55], QB_[55]);
  buf B287(QB[56], QB_[56]);
  buf B288(QB[57], QB_[57]);
  buf B289(QB[58], QB_[58]);
  buf B290(QB[59], QB_[59]);
  buf B291(QB[60], QB_[60]);
  buf B292(QB[61], QB_[61]);
  buf B293(QB[62], QB_[62]);
  buf B294(QB[63], QB_[63]);
  buf B295(QB[64], QB_[64]);
  buf B296(QB[65], QB_[65]);
  buf B297(QB[66], QB_[66]);
  buf B298(QB[67], QB_[67]);
  buf B299(QB[68], QB_[68]);
  buf B300(QB[69], QB_[69]);
  buf B301(QB[70], QB_[70]);
  buf B302(CLKA_, CLKA);
  buf B303(CENA_, CENA);
  buf B304(WENA_, WENA);
  buf B305(AA_[0], AA[0]);
  ...
  buf B320(DA_[8], DA[8]);
  buf B321(DA_[9], DA[9]);
  buf B322(DA_[10], DA[10]);
  buf B323(DA_[11], DA[11]);
  buf B324(DA_[12], DA[12]);
  buf B325(DA_[13], DA[13]);
  buf B326(DA_[14], DA[14]);
  buf B327(DA_[15], DA[15]);
  buf B328(DA_[16], DA[16]);
  buf B329(DA_[17], DA[17]);
  buf B330(DA_[18], DA[18]);
  buf B331(DA_[19], DA[19]);
  buf B332(DA_[20], DA[20]);
  buf B333(DA_[21], DA[21]);
  buf B334(DA_[22], DA[22]);
  buf B335(DA_[23], DA[23]);
  buf B336(DA_[24], DA[24]);
  buf B337(DA_[25], DA[25]);
  buf B338(DA_[26], DA[26]);
  buf B339(DA_[27], DA[27]);
  buf B340(DA_[28], DA[28]);
  buf B341(DA_[29], DA[29]);
  buf B342(DA_[30], DA[30]);
  buf B343(DA_[31], DA[31]);
  buf B344(DA_[32], DA[32]);
  buf B345(DA_[33], DA[33]);
  buf B346(DA_[34], DA[34]);
  buf B347(DA_[35], DA[35]);
  buf B348(DA_[36], DA[36]);
  buf B349(DA_[37], DA[37]);
  buf B350(DA_[38], DA[38]);
  buf B351(DA_[39], DA[39]);
  buf B352(DA_[40], DA[40]);
  buf B353(DA_[41], DA[41]);
  buf B354(DA_[42], DA[42]);
  buf B355(DA_[43], DA[43]);
  buf B356(DA_[44], DA[44]);
  buf B357(DA_[45], DA[45]);
  buf B358(DA_[46], DA[46]);
  buf B359(DA_[47], DA[47]);
  buf B360(DA_[48], DA[48]);
  buf B361(DA_[49], DA[49]);
  buf B362(DA_[50], DA[50]);
  buf B363(DA_[51], DA[51]);
  buf B364(DA_[52], DA[52]);
  buf B365(DA_[53], DA[53]);
  buf B366(DA_[54], DA[54]);
  buf B367(DA_[55], DA[55]);
  buf B368(DA_[56], DA[56]);
  buf B369(DA_[57], DA[57]);
  buf B370(DA_[58], DA[58]);
  buf B371(DA_[59], DA[59]);
  buf B372(DA_[60], DA[60]);
  buf B373(DA_[61], DA[61]);
  buf B374(DA_[62], DA[62]);
  buf B375(DA_[63], DA[63]);
  buf B376(DA_[64], DA[64]);
  buf B377(DA_[65], DA[65]);
  buf B378(DA_[66], DA[66]);
  buf B379(DA_[67], DA[67]);
  buf B380(DA_[68], DA[68]);
  buf B381(DA_[69], DA[69]);
  buf B382(DA_[70], DA[70]);
  buf B383(CLKB_, CLKB);
  buf B384(CENB_, CENB);
  buf B385(WENB_, WENB);
  buf B386(AB_[0], AB[0]);
  ...
  buf B401(DB_[8], DB[8]);
  buf B402(DB_[9], DB[9]);
  buf B403(DB_[10], DB[10]);
  buf B404(DB_[11], DB[11]);
  buf B405(DB_[12], DB[12]);
  buf B406(DB_[13], DB[13]);
  buf B407(DB_[14], DB[14]);
  buf B408(DB_[15], DB[15]);
  buf B409(DB_[16], DB[16]);
  buf B410(DB_[17], DB[17]);
  buf B411(DB_[18], DB[18]);
  buf B412(DB_[19], DB[19]);
  buf B413(DB_[20], DB[20]);
  buf B414(DB_[21], DB[21]);
  buf B415(DB_[22], DB[22]);
  buf B416(DB_[23], DB[23]);
  buf B417(DB_[24], DB[24]);
  buf B418(DB_[25], DB[25]);
  buf B419(DB_[26], DB[26]);
  buf B420(DB_[27], DB[27]);
  buf B421(DB_[28], DB[28]);
  buf B422(DB_[29], DB[29]);
  buf B423(DB_[30], DB[30]);
  buf B424(DB_[31], DB[31]);
  buf B425(DB_[32], DB[32]);
  buf B426(DB_[33], DB[33]);
  buf B427(DB_[34], DB[34]);
  buf B428(DB_[35], DB[35]);
  buf B429(DB_[36], DB[36]);
  buf B430(DB_[37], DB[37]);
  buf B431(DB_[38], DB[38]);
  buf B432(DB_[39], DB[39]);
  buf B433(DB_[40], DB[40]);
  buf B434(DB_[41], DB[41]);
  buf B435(DB_[42], DB[42]);
  buf B436(DB_[43], DB[43]);
  buf B437(DB_[44], DB[44]);
  buf B438(DB_[45], DB[45]);
  buf B439(DB_[46], DB[46]);
  buf B440(DB_[47], DB[47]);
  buf B441(DB_[48], DB[48]);
  buf B442(DB_[49], DB[49]);
  buf B443(DB_[50], DB[50]);
  buf B444(DB_[51], DB[51]);
  buf B445(DB_[52], DB[52]);
  buf B446(DB_[53], DB[53]);
  buf B447(DB_[54], DB[54]);
  buf B448(DB_[55], DB[55]);
  buf B449(DB_[56], DB[56]);
  buf B450(DB_[57], DB[57]);
  buf B451(DB_[58], DB[58]);
  buf B452(DB_[59], DB[59]);
  buf B453(DB_[60], DB[60]);
  buf B454(DB_[61], DB[61]);
  buf B455(DB_[62], DB[62]);
  buf B456(DB_[63], DB[63]);
  buf B457(DB_[64], DB[64]);
  buf B458(DB_[65], DB[65]);
  buf B459(DB_[66], DB[66]);
  buf B460(DB_[67], DB[67]);
  buf B461(DB_[68], DB[68]);
  buf B462(DB_[69], DB[69]);
  buf B463(DB_[70], DB[70]);
  buf B464(EMAA_[0], EMAA[0]);
  buf B465(EMAA_[1], EMAA[1]);
  buf B466(EMAA_[2], EMAA[2]);
  buf B467(EMAWA_[0], EMAWA[0]);
  buf B468(EMAWA_[1], EMAWA[1]);
  buf B469(EMASA_, EMASA);
  buf B470(EMAB_[0], EMAB[0]);
  buf B471(EMAB_[1], EMAB[1]);
  buf B472(EMAB_[2], EMAB[2]);
  buf B473(EMAWB_[0], EMAWB[0]);
  buf B474(EMAWB_[1], EMAWB[1]);
  buf B475(EMASB_, EMASB);
  buf B476(TENA_, TENA);
  buf B477(BENA_, BENA);
  buf B478(TCENA_, TCENA);
  buf B479(TWENA_, TWENA);
  buf B480(TAA_[0], TAA[0]);
  buf B481(TAA_[1], TAA[1]);
  buf B482(TAA_[2], TAA[2]);
  buf B483(TAA_[3], TAA[3]);
  buf B484(TAA_[4], TAA[4]);
  buf B485(TAA_[5], TAA[5]);
  buf B486(TAA_[6], TAA[6]);
  buf B487(TDA_[0], TDA[0]);
  buf B488(TDA_[1], TDA[1]);
  buf B489(TDA_[2], TDA[2]);
  buf B490(TDA_[3], TDA[3]);
  buf B491(TDA_[4], TDA[4]);
  buf B492(TDA_[5], TDA[5]);
  buf B493(TDA_[6], TDA[6]);
  buf B494(TDA_[7], TDA[7]);
  buf B495(TDA_[8], TDA[8]);
  buf B496(TDA_[9], TDA[9]);
  buf B497(TDA_[10], TDA[10]);
  buf B498(TDA_[11], TDA[11]);
  buf B499(TDA_[12], TDA[12]);
  buf B500(TDA_[13], TDA[13]);
  buf B501(TDA_[14], TDA[14]);
  buf B502(TDA_[15], TDA[15]);
  buf B503(TDA_[16], TDA[16]);
  buf B504(TDA_[17], TDA[17]);
  buf B505(TDA_[18], TDA[18]);
  buf B506(TDA_[19], TDA[19]);
  buf B507(TDA_[20], TDA[20]);
  buf B508(TDA_[21], TDA[21]);
  buf B509(TDA_[22], TDA[22]);
  buf B510(TDA_[23], TDA[23]);
  buf B511(TDA_[24], TDA[24]);
  buf B512(TDA_[25], TDA[25]);
  buf B513(TDA_[26], TDA[26]);
  buf B514(TDA_[27], TDA[27]);
  buf B515(TDA_[28], TDA[28]);
  buf B516(TDA_[29], TDA[29]);
  buf B517(TDA_[30], TDA[30]);
  buf B518(TDA_[31], TDA[31]);
  buf B519(TDA_[32], TDA[32]);
  buf B520(TDA_[33], TDA[33]);
  buf B521(TDA_[34], TDA[34]);
  buf B522(TDA_[35], TDA[35]);
  buf B523(TDA_[36], TDA[36]);
  buf B524(TDA_[37], TDA[37]);
  buf B525(TDA_[38], TDA[38]);
  buf B526(TDA_[39], TDA[39]);
  buf B527(TDA_[40], TDA[40]);
  buf B528(TDA_[41], TDA[41]);
  buf B529(TDA_[42], TDA[42]);
  buf B530(TDA_[43], TDA[43]);
  buf B531(TDA_[44], TDA[44]);
  buf B532(TDA_[45], TDA[45]);
  buf B533(TDA_[46], TDA[46]);
  buf B534(TDA_[47], TDA[47]);
  buf B535(TDA_[48], TDA[48]);
  buf B536(TDA_[49], TDA[49]);
  buf B537(TDA_[50], TDA[50]);
  buf B538(TDA_[51], TDA[51]);
  buf B539(TDA_[52], TDA[52]);
  buf B540(TDA_[53], TDA[53]);
  buf B541(TDA_[54], TDA[54]);
  buf B542(TDA_[55], TDA[55]);
  buf B543(TDA_[56], TDA[56]);
  buf B544(TDA_[57], TDA[57]);
  buf B545(TDA_[58], TDA[58]);
  buf B546(TDA_[59], TDA[59]);
  buf B547(TDA_[60], TDA[60]);
  buf B548(TDA_[61], TDA[61]);
  buf B549(TDA_[62], TDA[62]);
  buf B550(TDA_[63], TDA[63]);
  buf B551(TDA_[64], TDA[64]);
  buf B552(TDA_[65], TDA[65]);
  buf B553(TDA_[66], TDA[66]);
  buf B554(TDA_[67], TDA[67]);
  buf B555(TDA_[68], TDA[68]);
  buf B556(TDA_[69], TDA[69]);
  buf B557(TDA_[70], TDA[70]);
  buf B558(TQA_[0], TQA[0]);
  buf B559(TQA_[1], TQA[1]);
  buf B560(TQA_[2], TQA[2]);
  buf B561(TQA_[3], TQA[3]);
  buf B562(TQA_[4], TQA[4]);
  buf B563(TQA_[5], TQA[5]);
  buf B564(TQA_[6], TQA[6]);
  buf B565(TQA_[7], TQA[7]);
  buf B566(TQA_[8], TQA[8]);
  buf B567(TQA_[9], TQA[9]);
  buf B568(TQA_[10], TQA[10]);
  buf B569(TQA_[11], TQA[11]);
  buf B570(TQA_[12], TQA[12]);
  buf B571(TQA_[13], TQA[13]);
  buf B572(TQA_[14], TQA[14]);
  buf B573(TQA_[15], TQA[15]);
  buf B574(TQA_[16], TQA[16]);
  buf B575(TQA_[17], TQA[17]);
  buf B576(TQA_[18], TQA[18]);
  buf B577(TQA_[19], TQA[19]);
  buf B578(TQA_[20], TQA[20]);
  buf B579(TQA_[21], TQA[21]);
  buf B580(TQA_[22], TQA[22]);
  buf B581(TQA_[23], TQA[23]);
  buf B582(TQA_[24], TQA[24]);
  buf B583(TQA_[25], TQA[25]);
  buf B584(TQA_[26], TQA[26]);
  buf B585(TQA_[27], TQA[27]);
  buf B586(TQA_[28], TQA[28]);
  buf B587(TQA_[29], TQA[29]);
  buf B588(TQA_[30], TQA[30]);
  buf B589(TQA_[31], TQA[31]);
  buf B590(TQA_[32], TQA[32]);
  buf B591(TQA_[33], TQA[33]);
  buf B592(TQA_[34], TQA[34]);
  buf B593(TQA_[35], TQA[35]);
  buf B594(TQA_[36], TQA[36]);
  buf B595(TQA_[37], TQA[37]);
  buf B596(TQA_[38], TQA[38]);
  buf B597(TQA_[39], TQA[39]);
  buf B598(TQA_[40], TQA[40]);
  buf B599(TQA_[41], TQA[41]);
  buf B600(TQA_[42], TQA[42]);
  buf B601(TQA_[43], TQA[43]);
  buf B602(TQA_[44], TQA[44]);
  buf B603(TQA_[45], TQA[45]);
  buf B604(TQA_[46], TQA[46]);
  buf B605(TQA_[47], TQA[47]);
  buf B606(TQA_[48], TQA[48]);
  buf B607(TQA_[49], TQA[49]);
  buf B608(TQA_[50], TQA[50]);
  buf B609(TQA_[51], TQA[51]);
  buf B610(TQA_[52], TQA[52]);
  buf B611(TQA_[53], TQA[53]);
  buf B612(TQA_[54], TQA[54]);
  buf B613(TQA_[55], TQA[55]);
  buf B614(TQA_[56], TQA[56]);
  buf B615(TQA_[57], TQA[57]);
  buf B616(TQA_[58], TQA[58]);
  buf B617(TQA_[59], TQA[59]);
  buf B618(TQA_[60], TQA[60]);
  buf B619(TQA_[61], TQA[61]);
  buf B620(TQA_[62], TQA[62]);
  buf B621(TQA_[63], TQA[63]);
  buf B622(TQA_[64], TQA[64]);
  buf B623(TQA_[65], TQA[65]);
  buf B624(TQA_[66], TQA[66]);
  buf B625(TQA_[67], TQA[67]);
  buf B626(TQA_[68], TQA[68]);
  buf B627(TQA_[69], TQA[69]);
  buf B628(TQA_[70], TQA[70]);
  buf B629(TENB_, TENB);
  buf B630(BENB_, BENB);
  buf B631(TCENB_, TCENB);
  buf B632(TWENB_, TWENB);
  buf B633(TAB_[0], TAB[0]);
  buf B634(TAB_[1], TAB[1]);
  buf B635(TAB_[2], TAB[2]);
  buf B636(TAB_[3], TAB[3]);
  buf B637(TAB_[4], TAB[4]);
  buf B638(TAB_[5], TAB[5]);
  buf B639(TAB_[6], TAB[6]);
  buf B640(TDB_[0], TDB[0]);
  buf B641(TDB_[1], TDB[1]);
  buf B642(TDB_[2], TDB[2]);
  buf B643(TDB_[3], TDB[3]);
  buf B644(TDB_[4], TDB[4]);
  buf B645(TDB_[5], TDB[5]);
  buf B646(TDB_[6], TDB[6]);
  buf B647(TDB_[7], TDB[7]);
  buf B648(TDB_[8], TDB[8]);
  buf B649(TDB_[9], TDB[9]);
  buf B650(TDB_[10], TDB[10]);
  buf B651(TDB_[11], TDB[11]);
  buf B652(TDB_[12], TDB[12]);
  buf B653(TDB_[13], TDB[13]);
  buf B654(TDB_[14], TDB[14]);
  buf B655(TDB_[15], TDB[15]);
  buf B656(TDB_[16], TDB[16]);
  buf B657(TDB_[17], TDB[17]);
  buf B658(TDB_[18], TDB[18]);
  buf B659(TDB_[19], TDB[19]);
  buf B660(TDB_[20], TDB[20]);
  buf B661(TDB_[21], TDB[21]);
  buf B662(TDB_[22], TDB[22]);
  buf B663(TDB_[23], TDB[23]);
  buf B664(TDB_[24], TDB[24]);
  buf B665(TDB_[25], TDB[25]);
  buf B666(TDB_[26], TDB[26]);
  buf B667(TDB_[27], TDB[27]);
  buf B668(TDB_[28], TDB[28]);
  buf B669(TDB_[29], TDB[29]);
  buf B670(TDB_[30], TDB[30]);
  buf B671(TDB_[31], TDB[31]);
  buf B672(TDB_[32], TDB[32]);
  buf B673(TDB_[33], TDB[33]);
  buf B674(TDB_[34], TDB[34]);
  buf B675(TDB_[35], TDB[35]);
  buf B676(TDB_[36], TDB[36]);
  buf B677(TDB_[37], TDB[37]);
  buf B678(TDB_[38], TDB[38]);
  buf B679(TDB_[39], TDB[39]);
  buf B680(TDB_[40], TDB[40]);
  buf B681(TDB_[41], TDB[41]);
  buf B682(TDB_[42], TDB[42]);
  buf B683(TDB_[43], TDB[43]);
  buf B684(TDB_[44], TDB[44]);
  buf B685(TDB_[45], TDB[45]);
  buf B686(TDB_[46], TDB[46]);
  buf B687(TDB_[47], TDB[47]);
  buf B688(TDB_[48], TDB[48]);
  buf B689(TDB_[49], TDB[49]);
  buf B690(TDB_[50], TDB[50]);
  buf B691(TDB_[51], TDB[51]);
  buf B692(TDB_[52], TDB[52]);
  buf B693(TDB_[53], TDB[53]);
  buf B694(TDB_[54], TDB[54]);
  buf B695(TDB_[55], TDB[55]);
  buf B696(TDB_[56], TDB[56]);
  buf B697(TDB_[57], TDB[57]);
  buf B698(TDB_[58], TDB[58]);
  buf B699(TDB_[59], TDB[59]);
  buf B700(TDB_[60], TDB[60]);
  buf B701(TDB_[61], TDB[61]);
  buf B702(TDB_[62], TDB[62]);
  buf B703(TDB_[63], TDB[63]);
  buf B704(TDB_[64], TDB[64]);
  buf B705(TDB_[65], TDB[65]);
  buf B706(TDB_[66], TDB[66]);
  buf B707(TDB_[67], TDB[67]);
  buf B708(TDB_[68], TDB[68]);
  buf B709(TDB_[69], TDB[69]);
  buf B710(TDB_[70], TDB[70]);
  buf B711(TQB_[0], TQB[0]);
  buf B712(TQB_[1], TQB[1]);
  buf B713(TQB_[2], TQB[2]);
  buf B714(TQB_[3], TQB[3]);
  buf B715(TQB_[4], TQB[4]);
  buf B716(TQB_[5], TQB[5]);
  buf B717(TQB_[6], TQB[6]);
  buf B718(TQB_[7], TQB[7]);
  buf B719(TQB_[8], TQB[8]);
  buf B720(TQB_[9], TQB[9]);
  buf B721(TQB_[10], TQB[10]);
  buf B722(TQB_[11], TQB[11]);
  buf B723(TQB_[12], TQB[12]);
  buf B724(TQB_[13], TQB[13]);
  buf B725(TQB_[14], TQB[14]);
  buf B726(TQB_[15], TQB[15]);
  buf B727(TQB_[16], TQB[16]);
  buf B728(TQB_[17], TQB[17]);
  buf B729(TQB_[18], TQB[18]);
  buf B730(TQB_[19], TQB[19]);
  buf B731(TQB_[20], TQB[20]);
  buf B732(TQB_[21], TQB[21]);
  buf B733(TQB_[22], TQB[22]);
  buf B734(TQB_[23], TQB[23]);
  buf B735(TQB_[24], TQB[24]);
  buf B736(TQB_[25], TQB[25]);
  buf B737(TQB_[26], TQB[26]);
  buf B738(TQB_[27], TQB[27]);
  buf B739(TQB_[28], TQB[28]);
  buf B740(TQB_[29], TQB[29]);
  buf B741(TQB_[30], TQB[30]);
  buf B742(TQB_[31], TQB[31]);
  buf B743(TQB_[32], TQB[32]);
  buf B744(TQB_[33], TQB[33]);
  buf B745(TQB_[34], TQB[34]);
  buf B746(TQB_[35], TQB[35]);
  buf B747(TQB_[36], TQB[36]);
  buf B748(TQB_[37], TQB[37]);
  buf B749(TQB_[38], TQB[38]);
  buf B750(TQB_[39], TQB[39]);
  buf B751(TQB_[40], TQB[40]);
  buf B752(TQB_[41], TQB[41]);
  buf B753(TQB_[42], TQB[42]);
  buf B754(TQB_[43], TQB[43]);
  buf B755(TQB_[44], TQB[44]);
  buf B756(TQB_[45], TQB[45]);
  buf B757(TQB_[46], TQB[46]);
  buf B758(TQB_[47], TQB[47]);
  buf B759(TQB_[48], TQB[48]);
  buf B760(TQB_[49], TQB[49]);
  buf B761(TQB_[50], TQB[50]);
  buf B762(TQB_[51], TQB[51]);
  buf B763(TQB_[52], TQB[52]);
  buf B764(TQB_[53], TQB[53]);
  buf B765(TQB_[54], TQB[54]);
  buf B766(TQB_[55], TQB[55]);
  buf B767(TQB_[56], TQB[56]);
  buf B768(TQB_[57], TQB[57]);
  buf B769(TQB_[58], TQB[58]);
  buf B770(TQB_[59], TQB[59]);
  buf B771(TQB_[60], TQB[60]);
  buf B772(TQB_[61], TQB[61]);
  buf B773(TQB_[62], TQB[62]);
  buf B774(TQB_[63], TQB[63]);
  buf B775(TQB_[64], TQB[64]);
  buf B776(TQB_[65], TQB[65]);
  buf B777(TQB_[66], TQB[66]);
  buf B778(TQB_[67], TQB[67]);
  buf B779(TQB_[68], TQB[68]);
  buf B780(TQB_[69], TQB[69]);
  buf B781(TQB_[70], TQB[70]);
  buf B782(RET1N_, RET1N);
  buf B783(STOVA_, STOVA);
  buf B784(STOVB_, STOVB);
  buf B785(COLLDISN_, COLLDISN);
  ...
  assign DYA_ = RET1N_ ? (TENA_ ? DA_ : TDA_) : {71{1'bx}};
  ...
  assign DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {71{1'bx}};
   `ifdef ARM_FAULT_MODELING
     sram_keybuf2_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .TQ(TQA_), .BEN(BENA_), .WEN(WENA_int), .Q_in(QA_int));
  `else
  assign QA_ = RET1N_ ? (BENA_ ? ((STOVA_ ? (QA_int_delayed) : (QA_int))) : TQA_) : {71{1'bx}};
  `endif
  assign QB_ = RET1N_ ? (BENB_ ? ((STOVB_ ? (QB_int_delayed) : (QB_int))) : TQB_) : {71{1'bx}};
...
`endif
`timescale 1ns/1ps
module sram_keybuf2_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, BEN, TQ);
   output [70:0] Q_out;
   input [70:0] Q_in;
   input CLK;
   input [6:0] A;
...
begin
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.SMARCHCHKBVCD_LVISION_MBISTPG_ASSEMBLY_UNDER_TEST_INST.MEM0_MEM_INST.u1.add_fault(7'd2,7'd2,2'd1,2'd0);
   `endif
end
   task add_fault;
   //This task injects fault in memory
   //In order to inject fault in redundant column for Bit 0 to 34, column address
   //should have value in range of 4 to 7
   //In order to inject fault in redundant column for Bit 35 to 70, column address
...
begin
   ...
   begin
      ...
      begin
         ...
         begin
            if (row_address == A[6:3] && column_address == A[2:0])
            begin
               if (bitPlace < 35)
